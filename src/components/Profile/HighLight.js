...
const HighLight = ({auth:{uid} , highlight , date , open , handleDialogClose1 , setOpen1 , length}) => {
             ...
             <div className='story__item__click'>
               <div className='story__indicator'>
                  ...
                  <div className='story__info'>
                    ...
                    {user && <span className='username' onClick={()=>handleUserProfile(uid)}>{user.username}</span>}
